...
public class ByteBufOutPacket extends Packet {
    ...
    private short op;
    private static final Logger log = Logger.getLogger(ByteBufOutPacket.class);
    ...
    public ByteBufOutPacket(short op) {
        ...
        try {
            ...
            log.error("Failed to allocate ByteBuf for OutPacket, possible direct memory exhaustion", e);
        }
        encodeShort(op);
        this.op = op;
    }
